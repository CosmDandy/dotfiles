...
# Builds the bt-layout-switch binary and grants its TCC permissions.
# NOTE: the launchd agent itself is declared in nix-darwin and installed by
# darwin-rebuild switch — this script does NOT install it.
