...
# Everything below runs only for an actual ops command — a few per session against
# hundreds of ordinary ones. Keeping the second jq, the mkdir and the find here
# instead of at the top is what makes the common path cheap.
